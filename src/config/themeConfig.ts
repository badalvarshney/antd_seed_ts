...
export type InputSize = 'small' | 'middle' | 'large' | 'xlarge';
...
export type ErrorStyle = 'text' | 'highlight';
...
export interface ErrorStyleOption {
  id: ErrorStyle;
  name: string;
  subtitle: string;
}
...
export const COLOR_PRESETS: ColorPreset[] = [
  ...
  { name: 'Dark Red', primary: '#ff0000', hover: '#ff0000' },
];
...
export const INPUT_SIZE_OPTIONS: InputSizeOption[] = [
  ...
  { id: 'large', name: 'Large (44px)', subtitle: 'Large' },
  { id: 'xlarge', name: 'Extra Large (48px)', subtitle: 'Exact 48px Height' },
];
...
export const BUTTON_SHAPE_OPTIONS: InputShapeOption[] = [
  { id: 'standard', name: 'Standard (10px)', radius: 10 },
  { id: 'pill', name: 'Pill (Full Rounded)', radius: 50 },
  { id: 'smooth', name: 'Smooth (6px)', radius: 6 },
  { id: 'sharp', name: 'Sharp (0px)', radius: 0 },
...
export const ERROR_STYLE_OPTIONS: ErrorStyleOption[] = [
  { id: 'text', name: 'Text Only', subtitle: 'Minimal error text' },
  { id: 'highlight', name: 'Border & Glow', subtitle: 'Red border & shadow' },
];
