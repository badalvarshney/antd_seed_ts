  ...
  return (
    <div className="fade-in">
      ...
      <Form layout="vertical" onFinish={formik.handleSubmit}>
        <FormikAntdField name="password" label="New Password" formik={formik} required style={{ marginBottom: 6 }}>
          {(fieldProps) => (
            <Input.Password
              {...fieldProps}
        ...
        <FormikAntdField name="confirmPassword" label="Confirm New Password" formik={formik} required>
          {(fieldProps) => (
            <Input.Password
              {...fieldProps}
              prefix={<LockOutlined style={{ color: '#94a3b8' }} />}
